...
class MaintenancesControllerTest < ActionController::TestCase
  ...
  test "should create maintenance" do
    assert_difference('Maintenance.count') do
      post :create, maintenance: { cost: @maintenance.cost, date: @maintenance.date, maintenance_category_id: @maintenance.maintenance_category_id, mileage: @maintenance.mileage }
    end
  ...
  test "should update maintenance" do
    patch :update, id: @maintenance, maintenance: { cost: @maintenance.cost, date: @maintenance.date, maintenance_category_id: @maintenance.maintenance_category_id, mileage: @maintenance.mileage }
    assert_redirected_to maintenance_path(assigns(:maintenance))
  end
